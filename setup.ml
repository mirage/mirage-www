...
(* OASIS_START *)
(* DO NOT EDIT (digest: 22ee144c5a9383bcdb021939cd0f29ea) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Thomas Gazagnaire"; "Anil Madhavapeddy"; "Richard Mortier"];
          homepage = None;
          synopsis = "http://openmirage.org website";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "÷Ð,\131!\130µ\007\145¬\031õ\023Õ¹»";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
