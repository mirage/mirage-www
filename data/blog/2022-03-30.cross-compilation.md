...
We recommend having some familiarity with the MirageOS project in order to fully understand this article. See [mirageos.org/docs](https://mirageos.org/docs/) for more information on that matter.
...
KVM is now enabled by default in most Raspberry Pi kernel distributions, but for historical interest, this blog post shows how to enable KVM and cross-compile the Linux kernel: [https://mirageos.org/docs/arm64](https://mirageos.org/docs/arm64)
