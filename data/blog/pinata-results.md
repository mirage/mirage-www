...
Earlier this year, we [released a Bitcoin Piñata](/blog/announcing-bitcoin-pinata).
...
[MirageOS](/) unikernel.  You can see the [code manifest](https://github.com/mirleft/btc-pinata/blob/master/opam-full.txt) to find out which libraries are involved.  We put this online and invited people to attack it.
