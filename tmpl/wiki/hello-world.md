...
```
# Generated by Mirage (Tue, 14 Jul 2015 11:28:57 GMT).

name = 'block_test'
kernel = '/home/vagrant/mirage-skeleton/block/mir-block_test.xen'
builder = 'linux'
memory = 256
on_crash = 'preserve'
disk = [ '/home/vagrant/mirage-skeleton/block/disk.img,,xvda1' ]
```
...
Xen Minimal OS!
  start_info: 000000000022c000(VA)
    nr_pages: 0x10000
  shared_inf: 0x5e902000(MA)
     pt_base: 000000000022f000(VA)
nr_pt_frames: 0x5
    mfn_list: 00000000001ac000(VA)
   mod_start: 0x0(VA)
     mod_len: 0
       flags: 0x0
    cmd_line:
       stack: 000000000018ba80-00000000001aba80
MM: Init
      _text: 0000000000000000(VA)
     _etext: 00000000000cbdbf(VA)
   _erodata: 00000000000f1000(VA)
     _edata: 00000000001523e0(VA)
stack start: 000000000018ba80(VA)
       _end: 00000000001aba80(VA)
  start_pfn: 237
    max_pfn: 10000
Mapping memory range 0x400000 - 0x10000000
setting 0000000000000000-00000000000f1000 readonly
skipped 1000
MM: Initialise page allocator for 2b5000(2b5000)-10000000(10000000)
MM: done
Demand map pfns at 10001000-0000002010001000.
Initialising timer interface
Initialising console ... done.
...
Block.connect xvda1: interpreting xvda1 as a linux device string, translating to 51713
Block.connect xvda1 -> 51713
Blkfront.create; vdev=51713
Blkback can only use a single-page ring
Negotiated a single-page ring
Blkfront ring Blkif.51713 header_size = 64; index slot size = 112; number of entries = 32
state=Connected
Blkfront info: sector_size=512 sectors=100000 max_indirect_segments=0
sectors = 12500
read_write=true
sector_size=4096
writing 1 sectors at 0
writing 1 sectors at 12499
writing 2 sectors at 0
writing 2 sectors at 12498
writing 12 sectors at 0
writing 12 sectors at 12488
writing 1 sectors at 12500
writing 12 sectors at 12489
